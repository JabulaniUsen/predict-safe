// Static ISO 3166-1 country list. Previously fetched at runtime from
// restcountries.com, which deprecated its v3 API and now returns an error
// payload instead of country data, silently breaking every country picker.
